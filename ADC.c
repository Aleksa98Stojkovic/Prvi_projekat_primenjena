...
ADCSSL = 0b0000011100000000; // Pinovi B8 i B9 se koriste za TS, B10 je za MQ3
ADCON1bits.ASAM = 1;

IFS0bits.ADIF = 1; // Setovanje zastavice za ADC prekid
IEC0bits.ADIE = 1; // Dozvoli prekid za ADC
